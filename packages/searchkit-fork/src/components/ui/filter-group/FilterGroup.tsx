...
import {block, FastClick} from "../../../core/react"
...
export class FilterGroup extends React.Component<FilterGroupProps, any> {
  ...
  renderFilter(filter, bemBlocks) {
    ...
    return (
      <FilterGroupItem key={filter.value} itemKey={filter.value} bemBlocks={bemBlocks} filter={filter} label={translate(filter.value)}
