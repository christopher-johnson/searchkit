...
describe("View Switcher Hits component", () => {
  ...
  describe('renders correctly', () => {
      ...
      this.setWrapper = (props = {}) => {
        this.wrapper = mount(
          <div>
            ...
            <ViewSwitcherHits searchkit={this.searchkit} hitComponents={[
    ...
    it("Works with ViewSwitcherConfig", () => {
      this.wrapper = mount(
        <div>
          <ViewSwitcherConfig searchkit={this.searchkit} hitComponents={[
            {key: "grid", title: "Grid", itemComponent: MovieHitsGridItem, defaultOption: true},
            {key: "list", title: "List", itemComponent: MovieHitsListItem},
            {key: "custom-list", title: "Custom List", listComponent: MovieList}
          ]}/>
          <ViewSwitcherHits searchkit={this.searchkit} highlightFields={["title"]} hitsPerPage={12} sourceFilter={["title"]}/>
