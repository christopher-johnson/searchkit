...
import {ImmutableQuery, SearchkitManager} from "../../../../core";
...
describe("Pagination tests", () => {
  ...
  beforeEach(() => {
    ...
    this.createWrapper = (showNumbers = true, pageScope = 3, props = {}) => {
      this.wrapper = mount(
        <Pagination searchkit={this.searchkit} showNumbers={showNumbers} pageScope={pageScope}
          {...props} translations={{"pagination.previous": "Previous Page"}}/>
      );
