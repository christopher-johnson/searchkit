...
describe("Searchbox tests", () => {
  ...
  beforeEach(() => {
    ...
    this.createWrapper = (searchOnChange = false, queryFields = null, prefixQueryFields = null, options = {}) => {
      this.wrapper = mount(
        <SearchBox searchkit={this.searchkit} searchOnChange={searchOnChange} queryFields={queryFields}
          prefixQueryFields={prefixQueryFields} queryOptions={{minimum_should_match: "60%"}}
