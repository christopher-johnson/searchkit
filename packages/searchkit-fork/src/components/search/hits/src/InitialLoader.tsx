...
import {renderComponent, RenderComponentType, SearchkitComponent, SearchkitComponentProps} from "../../../../core"
  ...
  render() {
    return (
      <div className={this.props.bemBlocks.container()}>
        <div data-qa="initial-loading" className={this.props.bemBlocks.container("initial-loading")}/>
      </div>
    )
  }
}
