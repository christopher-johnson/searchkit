...
import {CustomHighlightAccessor, HighlightAccessor, PageSizeAccessor, SearchkitManager, SourceFilterAccessor} from "../../../../core";
...
describe("Hits component", () => {
  ...
  describe('renders correctly', () => {
    ...
    beforeEach(() => {
      ...
      this.wrapper = mount(
        <Hits searchkit={this.searchkit} hitsPerPage={10} highlightFields={["title"]} customHighlight={customHighlight}
          sourceFilter={["title"]}/>
      )
  ...
  describe("hits scrollTo", () => {
    ...
    beforeEach(() => {
      ...
      this.addHits = (scrollTo) => {
        ...
        this.wrapper = mount(
          <Hits searchkit={this.searchkit} scrollTo={scrollTo} hitsPerPage={10}/>
        )
      }
