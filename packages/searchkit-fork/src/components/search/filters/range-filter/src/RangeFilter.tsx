...
import {Panel, RangeProps, RangeSlider, RangeSliderHistogram} from "../../../../ui"
...
export class RangeFilter extends SearchkitComponent<RangeFilterProps, any> {
  ...
  defineAccessor() {
    const {
      ...
      interval, showHistogram, rangeFormatter, translations
    } = this.props
  ...
  renderRangeComponent(component: RenderComponentType<any>): any {
