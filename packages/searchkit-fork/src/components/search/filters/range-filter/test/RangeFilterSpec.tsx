...
import {RangeInput, RangeSliderHistogram} from "../../../../../components"
import {RangeAccessor, SearchkitManager} from "../../../../../core";
...
describe("Range Filter tests", () => {
  ...
  beforeEach(() => {
    ...
    this.createWrapper = ({
      ...
      this.wrapper = mount(
        <RangeFilter id="m" searchkit={this.searchkit} field="metascore" min={0} max={100} title="metascore" interval={interval}
          translations={{"range.divider": " to "}} rangeFormatter={this.rangeFormatter} rangeComponent={rangeComponent}
