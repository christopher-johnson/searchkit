...
import {DynamicRangeAccessor, SearchkitManager} from "../../../../core";
...
describe("Dynamic Range Filter tests", () => {
  ...
  beforeEach(() => {
    ...
    this.createWrapper = () => {
      this.wrapper = mount(
        <DynamicRangeFilter id="m" searchkit={this.searchkit} field="metascore" title="metascore" rangeFormatter={this.rangeFormatter}
