...
import {ResetSearchAccessor, SearchkitManager} from "../../../../../core";
...
describe("Reset Filter tests", () => {
  ...
  beforeEach(() => {
    ...
    this.createWrapper = () => {
      this.wrapper = mount(
        <ResetFilters searchkit={this.searchkit} translations={{"reset.clear_all": "reset filters"}} options={this.options}/>
      );
