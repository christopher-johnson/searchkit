...
import {ArrayState, FacetAccessor, SearchkitManager, Utils} from "../../../../core";
...
describe("MenuFilter", () => {
  ...
  beforeEach(() => {
    ...
    this.wrapper = mount(
      <MenuFilter searchkit={this.searchkit} translations={{"Red": "Red Translated"}} field="color" title="Color" orderKey="_term"
        orderDirection="asc" include="title" exclude={["n/a"]} id="color" size={10}/>
    )
    this.getOptionAt = (at) => {
