...
import {CheckboxFilterAccessor, SearchkitManager, TermQuery, Utils} from "../../../../core";
...
describe("CheckboxFilter tests", () => {
  ...
  beforeEach(() => {
    ...
    this.createWrapper(
      <CheckboxFilter id="test id" title="test title" label="test label" searchkit={this.searchkit}
