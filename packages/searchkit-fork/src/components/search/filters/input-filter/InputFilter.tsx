...
import {QueryAccessor, renderComponent, RenderComponentType, SearchkitComponent, SearchkitComponentProps} from "../../../../core";
    ...
    return renderComponent(containerComponent, {
      ...
      <div className={block().state({focused: this.state.focused})}>
        <form onSubmit={this.onSubmit.bind(this)}>
          ...
          <input type="text" data-qa="input-filter" className={block("text")}
            placeholder={this.props.placeholder || this.translate("searchbox.placeholder")} value={value}
            onFocus={this.setFocusState.bind(this, true)} onBlur={this.setFocusState.bind(this, false)} ref="queryField" autoFocus={false}
            onInput={this.onChange.bind(this)}/>
          <input type="submit" value={this.translate("searchbox.button")} className={block("action")} data-qa="submit"/>
          <div data-qa="remove" onClick={this.onClear} className={block("remove").state({hidden: value == ""})}/>
        </form>
      </div>
    );
  }
