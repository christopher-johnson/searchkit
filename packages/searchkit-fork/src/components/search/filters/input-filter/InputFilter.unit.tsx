...
import {QueryAccessor, QueryString, SearchkitManager} from "../../../../core";
...
describe("InputFilter tests", () => {
  ...
  beforeEach(() => {
    ...
    this.createWrapper = (searchOnChange = false, queryFields = null, prefixQueryFields = null, otherProps = {}) => {
      this.wrapper = mount(
        <InputFilter searchkit={this.searchkit} id="test_id" title="Test title" searchOnChange={searchOnChange} queryFields={queryFields}
  ...
  it("render", () => {
    this.createWrapper()
    expect(this.wrapper.find(".sk-input-filter__text").instance().placeholder).toBe("search placeholder")
    expect(this.wrapper.find(".sk-input-filter__action").instance().value).toBe("submit")
  })
