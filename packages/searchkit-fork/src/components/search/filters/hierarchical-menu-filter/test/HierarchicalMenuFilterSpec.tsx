...
import {HierarchicalFacetAccessor, SearchkitManager} from "../../../../../core";
...
describe("HierarchicalMenuFilter tests", () => {
  ...
  beforeEach(() => {
    ...
    this.wrapper = mount(
      <HierarchicalMenuFilter searchkit={this.searchkit} title="Categories" id="categories" orderKey="_term" orderDirection="asc"
        countFormatter={(count) => "#" + count} fields={["lvl1", "lvl2"]}/>
    )
