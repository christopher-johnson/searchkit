...
export class FastClickComponent extends React.PureComponent<any, any> {
  ...
  static getSinglePoint(event): Point {
  ...
  handleTouchStart(event) {
    ...
    this.startPoint = FastClickComponent.getSinglePoint(event)
  }
  ...
  handleTouchEnd(event) {
    if (this.startPoint) {
      let endPoint = FastClickComponent.getSinglePoint(event)
  ...
  render() {
    return React.cloneElement(this.props.children as React.ReactElement<any>, {
      ...
      onClick: FastClickComponent.handleClick.bind(this)
    })
  }
}
